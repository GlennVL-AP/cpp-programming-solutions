...
TEST_CASE("test leap year detection", "[labo_8][datetime]")
{
...
TEST_CASE("check if date is valid", "[labo_8][datetime]")
{
    using datetime::Day;
...
TEST_CASE("date class tests", "[labo_8][datetime]")
{
    using datetime::Day;
    using datetime::Month;
    using datetime::Year;
...
TEST_CASE("test comparing dates", "[labo_8][datetime]")
{
    using datetime::Day;
    using datetime::Month;
    using datetime::Year;
...
TEST_CASE("test incrementing dates", "[labo_8][datetime]")
{
    using datetime::Day;
    using datetime::Month;
    using datetime::Year;
...
TEST_CASE("date class properties", "[labo_8][datetime]")
{
