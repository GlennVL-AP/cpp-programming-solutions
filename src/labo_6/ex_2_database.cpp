...
export class PostgreSqlDatabase : public Database
{
public:
    void connect() override { std::println("Connecting to PostgreSQL database!"); }
    void query(std::string query) override { std::println("Executing PostgreSQL query {}", query); }
};
